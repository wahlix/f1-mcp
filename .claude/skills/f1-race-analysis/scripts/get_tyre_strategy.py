#!/usr/bin/env python3
"""
get_tyre_strategy.py — CLI wrapper around f1_lib.tyre_strategy.get_tyre_strategy().
...
from f1_lib.tyre_strategy import get_tyre_strategy  # noqa: E402


def main() -> None:
    parser = argparse.ArgumentParser(description="Fetch F1 tyre strategy for a driver/session.")
    ...
    parser.add_argument("--driver", type=str, required=True, help='Driver code, e.g. "ANT"')
    parser.add_argument(
        "--session",
        type=str,
        default="R",
