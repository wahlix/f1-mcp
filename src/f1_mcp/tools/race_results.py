"""
tools/race_results.py — fetches classified race results per driver from FastF1 data.

Pure function, no MCP dependency here. server.py wraps get_race_results()
...
from f1_mcp.models import RaceResultEntry, RaceResultsSummary
